...
public class CompactionTest extends TransactionsTestBase {
    ...
    void verifyCompaction() {
        ...
        submgr.subscribe(AccountCompactionEvent.QUAL_EVENT_NAME, consumer);
        ...
        if (eodInfo.status == CompletionInfo.Status.COMPLETED_OK) {
            ...
            Assertions.assertEquals(TEST_EVENT_COUNT + 2, consumer.getEventCount(), "Event count before compaction wrong");
        ...
        submgr.unsubscribe(AccountCompactionEvent.QUAL_EVENT_NAME, consumer);
    }
}
